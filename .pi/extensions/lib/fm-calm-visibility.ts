...
// Calm hides mid-turn assistant working notes, while the assistant layout keeps any
// substantive text that shares a message with tool calls, and the genuine final reply
// stays visible.
